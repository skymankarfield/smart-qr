...
<script type="text/javascript">
    ...
    if(typeof json != 'undefined'){
        ...
        for(var i = 0; json[i] != undefined; i++){
            table.addRow(Array("<a onselect='return false' onmousedown='return false'  class='cellLink' href='object.php?object_id="+ json[i]['object_id'] +"'>" + json[i]['nametitle'] + "</a>"));
        }
    } 
</script>
</head>
...
<div id="rightcontent">
<br />
<span class='title'>Scanned Exhibits</span><br />
<br />
This is the list of exhibits that you have scanned. This section is updated every 5 minutes.  You can click on the name of the poster to bring you to the poster profile.
<br><br>
